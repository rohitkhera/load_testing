...
public class Ciphering {
    ...
    public Ciphering(String plaintexts) {
	...
	String plaintexts = "e0c10203f40501070d99aa0c00d0890fa0c13203f40501070d99aa0c00d089ff";
	...
	for(int i = 0 ; i < numLoops ; i++) {
	    ...
	    Ciphering test = new Ciphering(plaintexts);
	
	    String ctext = test.getCipherText();

	}

	long stopTime = System.currentTimeMillis();

	System.out.println("Avg time for one op in ms " + (stopTime - startTime) / numLoops);
